export default function HeroPage() {
  return (
    <section className="bg-gray-50 py-8 antialiased dark:bg-slate-900 md:py-16 h-[100vh]">
      <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
        <div className="mb-4 flex items-center justify-between gap-4 md:mb-8 h-full">
